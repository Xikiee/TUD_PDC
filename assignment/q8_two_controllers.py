...
# integration factor: maybe this is not needed, idk check later what this really does  
int_H2 = 0.0
int_O2 = 0.0
...
for k in range(N-1):
    ...
    # chat has production flows for EP at time k here: 
    F3H2 = p2*EP_k
    F4O2 = p3*EP_k
    F3H2_series[k] = F3H2 
    F4O2_series[k] = F4O2
